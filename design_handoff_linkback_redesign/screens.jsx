...
function Btn({
  ...
  return (
    <button
      ...
      style={{
        height: sizeMap.h,
        padding: `0 ${sizeMap.px}px`,
        fontSize: sizeMap.fs,
        fontWeight: 500,
        letterSpacing: 0,
        background: variantMap.bg,
        color: variantMap.color,
        border: `1px solid ${variantMap.border}`,
        borderRadius: 6,
        cursor: "pointer",
        fontFamily: "inherit",
        display: "inline-flex",
        ...
        boxShadow:
          variant === "primary" ? "0 1px 2px rgba(0,0,0,0.05)" : "none",
        ...style,
      }}
    >
      {icon}
...
const ATTENDEES = [
  ...
  {
    name: "Sasha Volkov",
    headline: "Investor · Sequoia",
    initials: "SV",
    in: "11:31",
  },
  {
    name: "Tomás Ribeiro",
    headline: "Head of Platform · Notion",
    initials: "TR",
    in: "11:28",
  },
  {
    name: "Naomi Lindgren",
    headline: "Director of Ops · Vercel",
    initials: "NL",
    in: "11:24",
  },
  {
    name: "Kenji Araki",
    headline: "iOS Engineer · Arc",
    initials: "KA",
    in: "11:19",
  },
  {
    name: "Clara Bennett",
    headline: "CEO · Sunlit Labs",
    initials: "CB",
    in: "11:15",
  },
  {
    name: "Dmitri Orlov",
    headline: "VP Engineering · Supabase",
    initials: "DO",
    in: "11:10",
  },
];
...
function LandingScreen() {
  return (
    <Frame>
      ...
      <div style={{ padding: "96px 64px 0", position: "relative", zIndex: 1 }}>
        ...
        <div style={{ marginTop: 32, display: "flex", gap: 12 }}>
          <Btn
            variant="primary"
            size="lg"
            iconRight={<Icon path={Icons.arrowRight} size={16} />}
          >
            ...
            <div>
              ...
              <div style={{ display: "flex", gap: 8, marginTop: 18 }}>
                ...
                <Btn
                  variant="outline"
                  size="md"
                  icon={<Icon path={Icons.qr} size={14} />}
                >
                  QR
                </Btn>
              </div>
      ...
      {/* features */}
      <div
        style={{ padding: "96px 64px 64px", position: "relative", zIndex: 1 }}
      >
        <div
          style={{
            display: "grid",
  ...
  return (
    <Frame>
      ...
      >
        ...
        <Btn variant="ghost" size="sm" style={{ color: T.textMute }}>
          Close
        </Btn>
      </div>
      ...
      >
        ...
        >
          ...
          <span
            style={{ fontSize: 11, color: T.textMute, fontFamily: monoStack }}
          >
            OR
          </span>
          <div style={{ flex: 1, height: 1, background: T.borderSub }} />
...
function DashboardScreen() {
  const myEvents = [
    ...
    {
      name: "Design Engineering Mixer",
      date: "NOV 14 · 18:30",
      loc: "The Standard, High Line",
      count: 48,
      status: "draft",
    },
  ];
      ...
      <div style={{ flex: 1, overflowY: "auto", padding: "32px 40px" }}>
        ...
        >
          <div>
            ...
            <div style={{ fontSize: 14, color: T.textMute, marginTop: 6 }}>
              3 events hosted · 7 attended · 164 connections
            </div>
          </div>
          <Btn
            variant="primary"
            size="md"
            icon={<Icon path={Icons.plus} size={14} stroke={2} />}
          >
            Create event
          </Btn>
        </div>
          ...
          {myEvents.map((e, i) => (
            <div
              ...
              style={{
                ...
                gap: 16,
                borderBottom:
                  i < myEvents.length - 1 ? `1px solid ${T.borderSub}` : "none",
              }}
            >
              <div>
...
function CreateEventScreen() {
  const Field = ({ label, value, placeholder, mono, helper, focused }) => (
    <div style={{ display: "flex", flexDirection: "column", gap: 6 }}>
      ...
      {helper && (
        <span style={{ fontSize: 12, color: T.textMute }}>{helper}</span>
      )}
    </div>
  );
    ...
    <Frame bg={T.surface}>
      ...
      >
        <Btn
          variant="ghost"
          size="sm"
          icon={<Icon path={Icons.arrowLeft} size={14} />}
        >
          Back
        </Btn>
      ...
      >
        <div style={{ width: "100%", maxWidth: 640 }}>
          ...
          >
            <Field
              label="Event name"
              value="NY Founders Dinner"
              helper="Shows up at the top of the event page."
            />
            ...
            <Field
              label="Location"
              value="Le Bernardin · 155 W 51st St, New York"
              helper="Address or room name. Visible to attendees after check-in."
            />
            ...
            <div style={{ display: "flex", flexDirection: "column", gap: 6 }}>
              ...
              >
                Invite-only dinner for seed-stage founders working on tools for
                the next generation of builders. Light dinner, real
                conversation, small room.
              </div>
            </div>
            ...
            <div style={{ display: "flex", flexDirection: "column", gap: 6 }}>
              ...
              >
                ...
                >
                  ...
                  <div
                    style={{ fontSize: 12, color: T.textMute, marginTop: 6 }}
                  >
          ...
          >
            ...
            <Btn
              variant="primary"
              size="md"
              iconRight={<Icon path={Icons.arrowRight} size={14} />}
            >
              Continue
            </Btn>
          </div>
...
function EventPageScreen({ checkedIn = false }) {
  return (
    <Frame>
      ...
      >
        <span>9:41</span>
        <span style={{ fontSize: 10, letterSpacing: 2, color: T.textMute }}>
          ●●●
        </span>
      </div>
      ...
      >
        ...
        >
          EVENT · NY-FOUNDERS-OCT24
        </div>
        <Btn variant="outline" size="sm" style={{ width: 36, padding: 0 }}>
          <Icon path={Icons.share} size={14} />
        </Btn>
      </div>
      ...
      <div style={{ flex: 1, overflowY: "auto", padding: "0 20px 20px" }}>
        ...
        <div style={{ marginTop: 24 }}>
          {checkedIn ? (
            ...
            >
              ...
              <div style={{ flex: 1 }}>
                <div
                  style={{ fontSize: 14, fontWeight: 500, color: T.success }}
                >
                  Checked in at 11:42
                </div>
                <div style={{ fontSize: 12, color: T.success, opacity: 0.8 }}>
        ...
        <div style={{ marginTop: 32 }}>
          ...
          >
            ...
            <div
              style={{ fontSize: 12, color: T.textMute, fontFamily: monoStack }}
            >
    ...
    <Frame>
      ...
      >
        ...
        >
          ...
          >
            Nine other founders are already here. Introductions happen on the
            roster — it's updating live.
          </p>
          ...
          >
            ...
            >
              ...
              <span style={{ marginLeft: 10, fontSize: 13, fontWeight: 500 }}>
                + 5 more
              </span>
            </div>
          </div>
    ...
    >
      ...
      >
        ...
        >
          ...
          <Btn variant="ghost" size="sm" style={{ width: 32, padding: 0 }}>
        ...
        >
          <Btn
            variant="outline"
            size="md"
            icon={<Icon path={Icons.download} size={14} />}
          >
            Save
          </Btn>
          <Btn
            variant="primary"
            size="md"
            icon={<Icon path={Icons.share} size={14} />}
          >
            Share
          </Btn>
        </div>
...
function ComponentsSpec() {
  const Swatch = ({ c, n, h }) => (
    <div>
      ...
      <div style={{ fontSize: 11, color: T.textMute, fontFamily: monoStack }}>
        {h}
      </div>
    </div>
  );
  ...
  return (
    <Frame style={{ padding: 32 }}>
      ...
      >
        Structural clarity over decoration. 1px borders, flat surfaces,
      ...
      <div style={{ marginTop: 12, borderTop: `1px solid ${T.borderSub}` }}>
        {[
          ...
          { k: "h3", s: 20, w: 500, ls: -0.2, t: "Card title" },
          {
            k: "body-lg",
            s: 16,
            w: 400,
            ls: 0,
            t: "Primary reading text sits at 16px with a 1.5 line height for comfortable scanning.",
          },
          {
            k: "body",
            s: 14,
            w: 400,
            ls: 0,
            t: "Standard UI text, inputs, and row labels live at 14px.",
          },
          {
            k: "caption",
            s: 12,
            w: 400,
            ls: 0,
            t: "Metadata, helper text, timestamps.",
          },
        ].map((r) => (
          <div
            key={r.k}
          ...
          >
            <div
              style={{ fontSize: 11, fontFamily: monoStack, color: T.textMute }}
            >
              {r.k}
            </div>
            <div
            ...
            <div
              style={{ fontSize: r.s, fontWeight: r.w, letterSpacing: r.ls }}
            >
              {r.t}
            </div>
          </div>
