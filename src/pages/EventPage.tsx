...
import { ArrowLeft, Calendar, MapPin, QrCode, Share2 } from "lucide-react";
...
const EventPage = () => {
  ...
  // Date/time formatting (inlined from EventHeader)
  ...
  const timeZoneAbbreviation = useMemo(() => {
    const base = eventStartDate ?? eventEndDate;
    if (!base) return null;
    ...
    <div className="min-h-screen bg-bg-base flex flex-col">
      ...
      <div className="flex items-center px-4 pt-3 pb-4 gap-3">
        ...
        <Button
          ...
          onClick={() => {
            void navigator
              .share?.({ title: event.name, url: window.location.href })
              .catch(() => undefined);
          }}
        >
