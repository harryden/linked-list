    ...
    <div className="space-y-4">
      <div>
        <div className="grid grid-cols-[1fr_auto_auto] items-start sm:items-center gap-4">
          ...
          {isAttending && (
            <div className="col-start-2 self-start sm:self-center inline-flex items-center gap-2 text-state-success bg-state-success-bg border border-state-success px-3 py-1 rounded flex-none shrink-0 translate-x-[0.625rem] sm:translate-x-3">
